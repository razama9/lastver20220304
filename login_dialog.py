...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(QCoreApplication.translate("Dialog", u"メールアドレス", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"パスワード", None))
        self.login2_btn.setText(QCoreApplication.translate("Dialog", u"ログイン", None))
    # retranslateUi
