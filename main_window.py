...
"                                border-color: #7f8c8d}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_all_btn.setText(QCoreApplication.translate("MainWindow", u"全て選択", None))
        self.deselect_all_btn.setText(QCoreApplication.translate("MainWindow", u"全選択解除", None))
        self.import_btn.setText(QCoreApplication.translate("MainWindow", u"商品取り込み", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"一括値段設定", None))
        self.unit_radio_btn.setText(QCoreApplication.translate("MainWindow", u"単価(円)", None))
        self.percent_radio_btn.setText(QCoreApplication.translate("MainWindow", u"%(1~100)", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"時間間隔(秒指定)", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"~", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"秒", None))
        self.reduction_btn.setText(QCoreApplication.translate("MainWindow", u"実行", None))
        self.website_url.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><a href=\"https://accestrade.net\"><span style=\" color:#0000ff;\">支払い・お問い合わせ</span></a></p></body></html>", None))
        self.qr_code_label.setText(QCoreApplication.translate("MainWindow", u"QR コード", None))
        self.start_browser_btn.setText(QCoreApplication.translate("MainWindow", u"ブラウザ起動", None))
        self.quit_browser_btn.setText(QCoreApplication.translate("MainWindow", u"ブラウザを閉じる", None))
        self.login_btn.setText(QCoreApplication.translate("MainWindow", u"ログイン", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"コントロールボックス", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"商品名", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"価格", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"状態", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"商品ID", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"出品ステータス", None));
#if QT_CONFIG(tooltip)
        self.tableWidget.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.same_action_check.setText(QCoreApplication.translate("MainWindow", u"状態を全てに適応", None))
    # retranslateUi
