...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.email_input.setPlaceholderText(QCoreApplication.translate("Dialog", u"メールアドレスを入力", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"メールアドレス", None))
        self.login_btn.setText(QCoreApplication.translate("Dialog", u"ログイン", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"パスワード", None))
        self.password_input.setPlaceholderText(QCoreApplication.translate("Dialog", u"パスワードを入力", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"認証情報を確認しています。", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"認証が確認できません。お問い合わせください", None))
        self.try_again_btn.setText(QCoreApplication.translate("Dialog", u"再試行", None))
    # retranslateUi
